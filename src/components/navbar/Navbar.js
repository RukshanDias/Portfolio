...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between flex-wrap py-4 px-20 ">
            <div className="flex items-center flex-shrink-0 text-black mr-6 lg:mr-72 text-2xl">
            ...
            <div className={`w-full block flex-grow lg:flex lg:items-center lg:w-auto ${isOpen ? "block" : "hidden"}`}>
                <div className="text-sm lg:flex-grow">
                    <a href="#about" className="block mt-4 lg:inline-block lg:mt-0 text-white-200 mx-10 text-xl" rel="noopener noreferrer">
                        About
                    </a>
                    <a href="#projects" className="block mt-4 lg:inline-block lg:mt-0 text-white-200 mx-10 text-xl" rel="noopener noreferrer">
                        Projects
                    </a>
                    <a href="#about" className="block mt-4 lg:inline-block lg:mt-0 text-white-200 mx-10 text-xl" rel="noopener noreferrer">
                        Skills
